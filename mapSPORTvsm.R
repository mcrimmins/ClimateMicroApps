...
mapDate<-fileList$date[which(fileList$date==max(fileList$date) & fileList$var=="vsm0-40cm" & fileList$fileType=="float" & fileList$spatial=="wgs84.tif")]
...
mapSMFig<-levelplot(mapSM, contour=FALSE, margin=FALSE, at=at,
                   ...
                   main=paste0("NASA-LIS 0-40cm Volumetric Soil\nMoisture Percentile: ",mapDate))+
